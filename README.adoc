...
See [Thought Process](https://github.com/spring-io/nohttp/tree/master/nohttp#thought-process)

*Are Whitelists Supported*

See [Whitelisted HTTP URLs](https://github.com/spring-io/nohttp/tree/master/nohttp#whitelisted-http-urls)
